...
export default function LocationComponent({localImg,localText,localTitle,location,disableSearch,displayPreview}){
        ...
        <div className='event-place'>
                ...
                <div className='event-content'>
                    ...
                    <div className='event-description'>
                        ...
                        {
                            displayPreview?
                            <div className='event-description-text  event-preview' data-testid="preview-event-desc">
                            {
                                localText!==""?
                                localText
                                :

              ...
              <div className="trendy-event" key={key}>
                ...
                <div className="trendy-info">
                  ...
                  <button
                    className="main-btn"
                    onClick={() =>
                      navigate("/event", { state: { eventId: val.eventID } })
                    }
                  >
                    Kup teraz
                  </button>
      ...
      <main className="content">
        <div className="info">
          ...
          <div className="info-right">
            ...
            <br />
            <p>
              Najlepszego miejsca, aby zapewnić sobie bilety na najbardziej
              ekscytujące wydarzenia! Jeśli jesteście gotowi na niesamowite
              przygody, niezwykłe spektakle i niezapomniane chwile, to trafiłeś
              we właściwe miejsce.
            </p>
            <br />
            <p>
              Nasze doświadczenie i zaangażowanie sprawiają, że każdy zakupiony
              u nas bilet staje się wyjątkowym przeżyciem. Pragniemy zapewnić
              Wam dostęp do najbardziej ekskluzywnych i popularnych wydarzeń,
              abyście mogli delektować się ich magią i energią.
            </p>
          </div>
        </div>
        <div className="trendy">
          <div>
            <div className="content-header">Na czasie</div>
            <EventsController>
              <TrendyContent />
            </EventsController>
          </div>
        ...
        <div className="popular-places">
          <div>
            <div className="content-header">Najpopularniejsze miejsca</div>
            <EventsController>
              <MostPopularPlaces />
            </EventsController>
          </div>

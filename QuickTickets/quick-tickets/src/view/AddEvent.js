        ...
        <div className="content-data">
          <div className="content-data-column formColumn">
            ...
            <GreenInput
              ...
              fullWidth
              type="text"
              inputProps={{ "data-testid": "test-event-title" }}
            ></GreenInput>
            <div className="addEventOption">
                  ...
                  {locationsList.map((val, key) => {
                    return (
                      <button
                        ...
                        key={key}
                        onClick={() => selectLocation(val.name, val.locationID)}
                        value={val.name}
                      >
                        {val.name}
                      </button>
              ...
              <button
                data-testid="buttonn"
                className="filteringButton addEvent-filtering"
                onClick={handleOpenPlace}
              >
                <img className="leftIcon" src={place} />
                <div className="filteringTitle">{selecredLocation}</div>
                <img className="rightIcon" src={arrow} />
              </button>
            </div>
            <div className="addEventOption">
              {openCategory ? (
                  ...
                  {categoryList.map((val, key) => {
                    return (
                      <button
                        ...
                        key={key}
                        onClick={() =>
                          selectCategory(val.description, val.typeID)
                        }
                      >
                        {val.description}
                      </button>
              ...
              <button
                data-testid="buttonn2"
                className="filteringButton addEvent-filtering"
                onClick={handleOpenCategory}
              >
                <img className="leftIcon" src={category} />
                <div className="filteringTitle">{selectedCategory}</div>
                <img className="rightIcon" src={arrow} />
              </button>
            </div>
            <GreenInput
              ...
              fullWidth
              type="number"
              inputProps={{ "data-testid": "test-event-seats" }}
            ></GreenInput>
            <GreenInput
              value={ticketPrice}
              label="Cena biletu"
              ...
              fullWidth
              type="number"
              inputProps={{ "data-testid": "test-event-price" }}
            ></GreenInput>
            <GreenInput
              value={description}
              label="Opis"
              ...
              multiline
              rows={4}
              inputProps={{ "data-testid": "test-event-description" }}
            ></GreenInput>
            ...
            <GreenInput
              ...
              fullWidth
              type="text"
              inputProps={{ "data-testid": "test-event-img" }}
            ></GreenInput>

            <FormControlLabel
              control={
                <Checkbox
                  inputProps={{ "data-testid": "test-event-adultsOnly" }}
                />
              }
            ...
            {editMode ? (
              <button className="main-btn" onClick={() => clickUpdateEvent()}>
                Zapisz
              </button>
            ) : (
              <button className="main-btn" onClick={() => addNewEvent()}>
                Dodaj
              </button>
            )}
          </div>
...
function AddEvent() {
  ...
  React.useEffect(() => {
    if (checkIsLogged() === "3") setReady(true);
    else navigate("/home");
  }, []);
  return (
    <div className="App">

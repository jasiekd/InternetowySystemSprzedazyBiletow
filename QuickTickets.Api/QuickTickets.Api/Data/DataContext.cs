...
namespace QuickTickets.Api.Data
{
    public class DataContext : DbContext
    {
        ...
        public DbSet<UserEventHistoryEntity> UserEventHistory { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<EventsEntity>().HasData(
                new EventsEntity
                {
                    ...
                    Date = DateTime.ParseExact("30-01-2025 18:00", "dd-MM-yyyy HH:mm", CultureInfo.InvariantCulture),
                ...
                new EventsEntity
                {
                    ...
                    Date = DateTime.ParseExact("01-01-2025 12:00", "dd-MM-yyyy HH:mm", CultureInfo.InvariantCulture),
                    Status = StatusEnum.Confirmed.ToString(),
                    IsActive = true,
                    AdultsOnly = false,
                    TypeID = 3,
                ...
                new EventsEntity
                {
                    ...
                    Date = DateTime.ParseExact("03-01-2025 18:00", "dd-MM-yyyy HH:mm", CultureInfo.InvariantCulture),
                    Status = StatusEnum.Confirmed.ToString(),
                    IsActive = true,
                    AdultsOnly = false,
                    TypeID = 1,
                ...
                new EventsEntity
                {
                    ...
                    Date = DateTime.ParseExact("30-01-2025 12:00", "dd-MM-yyyy HH:mm", CultureInfo.InvariantCulture),
                    Status = StatusEnum.Confirmed.ToString(),
                    IsActive = true,
                    AdultsOnly = true,
                    TypeID = 6,
                ...
                new EventsEntity
                {
                    ...
                    TicketPrice = 50,
                    Description = "test",
                    Date = DateTime.ParseExact("18-01-2025 16:18", "dd-MM-yyyy HH:mm", CultureInfo.InvariantCulture),
                    Status = StatusEnum.Confirmed.ToString(),
                    IsActive = true,
                    AdultsOnly = true,
                    TypeID = 6,

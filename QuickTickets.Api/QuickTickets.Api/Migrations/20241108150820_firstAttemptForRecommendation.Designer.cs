...
namespace QuickTickets.Api.Migrations
{
    ...
    [Migration("20241108150820_firstAttemptForRecommendation")]
    partial class firstAttemptForRecommendation
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("QuickTickets.Api.Entities.AccountEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DateCreated = new DateTime(2024, 11, 8, 16, 8, 20, 478, DateTimeKind.Local).AddTicks(7676),
                        ...
                        new
                        {
                            ...
                            DateCreated = new DateTime(2024, 11, 8, 16, 8, 20, 478, DateTimeKind.Local).AddTicks(7906),
            ...
            modelBuilder.Entity("QuickTickets.Api.Entities.EventsEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DateCreated = new DateTime(2024, 11, 8, 16, 8, 20, 478, DateTimeKind.Local).AddTicks(8022),
                            DateModified = new DateTime(2024, 11, 8, 16, 8, 20, 478, DateTimeKind.Local).AddTicks(8025),
                        ...
                        new
                        {
                            ...
                            DateCreated = new DateTime(2024, 11, 8, 16, 8, 20, 478, DateTimeKind.Local).AddTicks(8069),
                            DateModified = new DateTime(2024, 11, 8, 16, 8, 20, 478, DateTimeKind.Local).AddTicks(8071),
                        ...
                        new
                        {
                            ...
                            DateCreated = new DateTime(2024, 11, 8, 16, 8, 20, 478, DateTimeKind.Local).AddTicks(8085),
                            DateModified = new DateTime(2024, 11, 8, 16, 8, 20, 478, DateTimeKind.Local).AddTicks(8087),
                        ...
                        new
                        {
                            ...
                            DateCreated = new DateTime(2024, 11, 8, 16, 8, 20, 478, DateTimeKind.Local).AddTicks(8098),
                            DateModified = new DateTime(2024, 11, 8, 16, 8, 20, 478, DateTimeKind.Local).AddTicks(8100),

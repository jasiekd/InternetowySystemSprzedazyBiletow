...
namespace QuickTickets.Api.Migrations
{
    ...
    [Migration("20230601094154_modifiedLocations")]
    partial class modifiedLocations
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("QuickTickets.Api.Entities.AccountEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("8e746219-a64c-4d88-b713-0c1b35604cbf"),
                            DateCreated = new DateTime(2023, 6, 1, 11, 41, 54, 250, DateTimeKind.Local).AddTicks(6331),
                        ...
                        new
                        {
                            Id = new Guid("4761490a-a5e9-4f98-b8f5-1843c81d2b04"),
                            DateCreated = new DateTime(2023, 6, 1, 11, 41, 54, 250, DateTimeKind.Local).AddTicks(6396),
            ...
            modelBuilder.Entity("QuickTickets.Api.Entities.EventsEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DateCreated = new DateTime(2023, 6, 1, 11, 41, 54, 250, DateTimeKind.Local).AddTicks(6436),
                        ...
                        new
                        {
                            ...
                            DateCreated = new DateTime(2023, 6, 1, 11, 41, 54, 250, DateTimeKind.Local).AddTicks(6455),
                        ...
                        new
                        {
                            ...
                            DateCreated = new DateTime(2023, 6, 1, 11, 41, 54, 250, DateTimeKind.Local).AddTicks(6462),
                        ...
                        new
                        {
                            ...
                            DateCreated = new DateTime(2023, 6, 1, 11, 41, 54, 250, DateTimeKind.Local).AddTicks(6467),

...
namespace QuickTickets.Api.Migrations
{
    ...
    [Migration("20230603113630_OrganiserApplication")]
    partial class OrganiserApplication
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("QuickTickets.Api.Entities.AccountEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DateCreated = new DateTime(2023, 6, 3, 13, 36, 30, 763, DateTimeKind.Local).AddTicks(2224),
                        ...
                        new
                        {
                            Id = new Guid("c5f2a066-77b9-4d29-b6b4-a66ec3a7644f"),
                            DateCreated = new DateTime(2023, 6, 3, 13, 36, 30, 763, DateTimeKind.Local).AddTicks(2484),
            ...
            modelBuilder.Entity("QuickTickets.Api.Entities.EventsEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DateCreated = new DateTime(2023, 6, 3, 13, 36, 30, 763, DateTimeKind.Local).AddTicks(2569),
                            DateModified = new DateTime(2023, 6, 3, 13, 36, 30, 763, DateTimeKind.Local).AddTicks(2571),
                        ...
                        new
                        {
                            ...
                            DateCreated = new DateTime(2023, 6, 3, 13, 36, 30, 763, DateTimeKind.Local).AddTicks(2711),
                            DateModified = new DateTime(2023, 6, 3, 13, 36, 30, 763, DateTimeKind.Local).AddTicks(2712),
                        ...
                        new
                        {
                            ...
                            DateCreated = new DateTime(2023, 6, 3, 13, 36, 30, 763, DateTimeKind.Local).AddTicks(2727),
                            DateModified = new DateTime(2023, 6, 3, 13, 36, 30, 763, DateTimeKind.Local).AddTicks(2729),
                        ...
                        new
                        {
                            ...
                            DateCreated = new DateTime(2023, 6, 3, 13, 36, 30, 763, DateTimeKind.Local).AddTicks(2737),
                            DateModified = new DateTime(2023, 6, 3, 13, 36, 30, 763, DateTimeKind.Local).AddTicks(2738),

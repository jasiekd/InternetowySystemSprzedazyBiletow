    ...
    public partial class final : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("2ef422ae-0e8e-4f47-93bb-8b79f04123b6"), new DateTime(2024, 12, 12, 16, 28, 24, 95, DateTimeKind.Local).AddTicks(5234), new DateTime(2000, 11, 4, 0, 0, 0, 0, DateTimeKind.Unspecified), "agardian00@cos.nie", null, false, "agardian", "041120001", "Artur", "jGl25bVBBBW96Qi9Te4V37Fnqchz/Eu4qB9vKrRIqRg=", 1, "Gardian" },
                    { new Guid("bb47eede-6953-43df-a26f-cdac99be8e87"), new DateTime(2024, 12, 12, 16, 28, 24, 95, DateTimeKind.Local).AddTicks(5298), new DateTime(2002, 6, 11, 0, 0, 0, 0, DateTimeKind.Unspecified), "jkowalski01@cos.nie", null, false, "jkowalski", "110620021", "Jan", "jGl25bVBBBW96Qi9Te4V37Fnqchz/Eu4qB9vKrRIqRg=", 3, "Kowalski" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1L, true, new DateTime(2025, 1, 30, 18, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2024, 12, 12, 16, 28, 24, 95, DateTimeKind.Local).AddTicks(5381), new DateTime(2024, 12, 12, 16, 28, 24, 95, DateTimeKind.Local).AddTicks(5383), "\"Ludzie trzymajcie kapelusze\" to mój drugi solowy program, grany od grudnia 2016 do sierpnia 2017 roku.  Udostępniony materiał został zarejestrowany 10 lipca 2017 roku w gdańskim klubie \"Parlament\". Obok mnie na scenie pojawił się również Adam Van Bendler.", "https://images.unsplash.com/photo-1610964199131-5e29387e6267?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1932&q=80", true, 2L, new Guid("bb47eede-6953-43df-a26f-cdac99be8e87"), 123, "Confirmed", 10f, "Ludzie trzymajcie spodnie", 7L },
                    { 2L, false, new DateTime(2025, 1, 1, 12, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2024, 12, 12, 16, 28, 24, 95, DateTimeKind.Local).AddTicks(5416), new DateTime(2024, 12, 12, 16, 28, 24, 95, DateTimeKind.Local).AddTicks(5417), "Spływ kajakiem po rzece Morawka", "https://images.unsplash.com/photo-1472745942893-4b9f730c7668?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1169&q=80", true, 6L, new Guid("bb47eede-6953-43df-a26f-cdac99be8e87"), 60, "Confirmed", 25f, "Spływ kajakowy", 3L },
                    { 3L, false, new DateTime(2025, 1, 3, 18, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2024, 12, 12, 16, 28, 24, 95, DateTimeKind.Local).AddTicks(5425), new DateTime(2024, 12, 12, 16, 28, 24, 95, DateTimeKind.Local).AddTicks(5426), "W swoim wykonaniu Pani Żak zaprezentuje swoje umiejętności artystyczne.", "https://images.unsplash.com/photo-1521116103845-2170f3377fec?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80", true, 5L, new Guid("bb47eede-6953-43df-a26f-cdac99be8e87"), 100, "Confirmed", 15f, "Recital Pani Żak", 1L },
                    { 4L, true, new DateTime(2025, 1, 30, 12, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2024, 12, 12, 16, 28, 24, 95, DateTimeKind.Local).AddTicks(5432), new DateTime(2024, 12, 12, 16, 28, 24, 95, DateTimeKind.Local).AddTicks(5433), "W naszej ofercie po prostu tak jakby przedstawimy oferty grona firm mówiących o swoich zapotrzebowaniach i planach dla widza.", "https://images.unsplash.com/photo-1618092388874-e262a562887f?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1025&q=80", true, 1L, new Guid("bb47eede-6953-43df-a26f-cdac99be8e87"), 600, "Confirmed", 50f, "Targi pracy", 6L },
                    { 5L, true, new DateTime(2025, 1, 18, 16, 18, 0, 0, DateTimeKind.Unspecified), new DateTime(2024, 12, 12, 16, 28, 24, 95, DateTimeKind.Local).AddTicks(5439), new DateTime(2024, 12, 12, 16, 28, 24, 95, DateTimeKind.Local).AddTicks(5440), "test", "https://images.unsplash.com/photo-1618092388874-e262a562887f?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1025&q=80", true, 1L, new Guid("bb47eede-6953-43df-a26f-cdac99be8e87"), 600, "Confirmed", 50f, "Targi pracy4", 6L }
                });

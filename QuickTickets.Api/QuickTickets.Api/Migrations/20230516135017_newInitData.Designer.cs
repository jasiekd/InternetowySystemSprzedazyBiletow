...
namespace QuickTickets.Api.Migrations
{
    ...
    [Migration("20230516135017_newInitData")]
            ...
            modelBuilder.Entity("QuickTickets.Api.Entities.AccountEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("baa8ac59-26bf-4ef5-8d1b-d8ed9fb35ce7"),
                            DateCreated = new DateTime(2023, 5, 16, 15, 50, 17, 279, DateTimeKind.Local).AddTicks(5734),

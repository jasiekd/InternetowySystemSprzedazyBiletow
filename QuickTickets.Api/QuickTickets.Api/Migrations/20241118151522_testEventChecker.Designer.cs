...
namespace QuickTickets.Api.Migrations
{
    ...
    [Migration("20241118151522_testEventChecker")]
    partial class testEventChecker
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("QuickTickets.Api.Entities.AccountEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DateCreated = new DateTime(2024, 11, 18, 16, 15, 22, 104, DateTimeKind.Local).AddTicks(5979),
                        ...
                        new
                        {
                            ...
                            DateCreated = new DateTime(2024, 11, 18, 16, 15, 22, 104, DateTimeKind.Local).AddTicks(6065),
            ...
            modelBuilder.Entity("QuickTickets.Api.Entities.EventsEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DateCreated = new DateTime(2024, 11, 18, 16, 15, 22, 104, DateTimeKind.Local).AddTicks(6117),
                            DateModified = new DateTime(2024, 11, 18, 16, 15, 22, 104, DateTimeKind.Local).AddTicks(6118),
                        ...
                        new
                        {
                            ...
                            DateCreated = new DateTime(2024, 11, 18, 16, 15, 22, 104, DateTimeKind.Local).AddTicks(6153),
                            DateModified = new DateTime(2024, 11, 18, 16, 15, 22, 104, DateTimeKind.Local).AddTicks(6154),
                        ...
                        new
                        {
                            ...
                            DateCreated = new DateTime(2024, 11, 18, 16, 15, 22, 104, DateTimeKind.Local).AddTicks(6163),
                            DateModified = new DateTime(2024, 11, 18, 16, 15, 22, 104, DateTimeKind.Local).AddTicks(6164),
                        ...
                        new
                        {
                            ...
                            DateCreated = new DateTime(2024, 11, 18, 16, 15, 22, 104, DateTimeKind.Local).AddTicks(6170),
                            DateModified = new DateTime(2024, 11, 18, 16, 15, 22, 104, DateTimeKind.Local).AddTicks(6172),
                        ...
                        new
                        {
                            EventID = 5L,
                            AdultsOnly = true,
                            Date = new DateTime(2024, 11, 18, 16, 18, 0, 0, DateTimeKind.Unspecified),
                            DateCreated = new DateTime(2024, 11, 18, 16, 15, 22, 104, DateTimeKind.Local).AddTicks(6178),
                            DateModified = new DateTime(2024, 11, 18, 16, 15, 22, 104, DateTimeKind.Local).AddTicks(6179),
                            Description = "test",
                            ImgURL = "https://images.unsplash.com/photo-1618092388874-e262a562887f?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1025&q=80",
                            IsActive = true,
                            LocationID = 1L,

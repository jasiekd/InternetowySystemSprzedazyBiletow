...
namespace QuickTickets.Api.Migrations
{
    ...
    [Migration("20230516114849_events")]
            ...
            modelBuilder.Entity("QuickTickets.Api.Entities.AccountEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("7a8d0b4e-5d46-4e9d-ab7b-6bc665b11953"),
                            DateCreated = new DateTime(2023, 5, 16, 13, 48, 49, 819, DateTimeKind.Local).AddTicks(8692),
